...
if (isset($_POST['save'])) {
  ...
  if ($_POST['save'] == "Save") {
    $save_sql = "INSERT INTO `amrhaha`( `name`, `email`, `password`, `mobile`) VALUES 
          ('$name','$email','$password','$mobile')";
  }else{
    $id= $_POST['id'] ;
    $save_sql = "UPDATE `amrhaha` SET `name`='$name',`email`='$email' ,`mobile`='$mobile' ,
...
if (isset($_GET['action']) && $_GET['action'] == 'del') {
  $id = $_GET['id'];
  $del_sql = "DELETE FROM amrhaha WHERE id = $id";
